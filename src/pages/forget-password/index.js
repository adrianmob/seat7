...
export default class ForgetPassword extends Component {
	state = {
		email: "",
		authenticated: false,
		button_text: "Send password to my email",
		sent: false,
		error: ""
	}

	hendleForgetPassword = async (e) => {
			...
			<div data-page="forget-password">
				...
				<div className="container-sign-in">
					...
					<div className="form">
						...
						<div className="label">
							<button type="submit" onClick={() => this.hendleForgetPassword()} className={`btn btn-send ${this.state.sent===true?'inactive':'active'}`}> {this.state.button_text} </button>
						</div>
