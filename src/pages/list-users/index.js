...
export default class ListUsers extends Component {
	...
	countUsers = async(page, view, filter) => {
		...
		//uploads users for the current page
	...
	render() {
		...
		return (
			<div data-page="list-users">
				<Header />
				
				<TitlePage title="Clients list"/>
						...
						<div data-component="content-list-header">
							<div className="row">
								<div className="actions">
									<Link to="/user/0" className="btn blue">New Client</Link>

									<div data-component="dropdown">
										<p className="dropdown-text">{this.state.filter}</p>
										<div className="dropdown-submenu">
											<button className="link" onClick={() => this.countUsers(this.state.page, this.state.view, "All Clients")}>All clients</button>
											<button className="link" onClick={() => this.countUsers(this.state.page, this.state.view, "Active")}>Active</button>
											<button className="link" onClick={() => this.countUsers(this.state.page, this.state.view, "Inactive")}>Inactive</button>
											<button className="link" onClick={() => this.countUsers(this.state.page, this.state.view, "New Request")}>New Request</button>
										</div>
									</div>
						...
						<div data-component="content-list-body">
							<div className="list-body-header">
								<div className="desktop">
									...
									<div className="col-inverse flex align-center lg-5">
										<strong className="body-title">Company</strong>
									</div>
									<div className="col-inverse flex align-center lg-7 header-status">
										<strong className="body-title">Status</strong>
									</div>
									<div className="col-inverse flex align-center lg-11 header-actions">
							...
							<div className="list-body-content">
								{this.state.clients.map(client => (
									<div className="list-item" key={client.user_id}>
										...
										<div className="col-inverse flex align-center sm-1 md-1 lg-5 body-company" data-title="Company:">
											<p className="body-text">
												{client.companies.map(companie => (
													companie.name
												))}
											</p>
										</div>
										<div className="col-inverse flex align-center justfy-center sm-2 md-2 lg-7 body-status" data-title="Status:">
											{client.active}
											<Status status={client.active} />
										</div>
				...
				<div data-component="modal" className={`modal-cancel ${this.state.modal_delete}`}>
					<div className="content">
						<p className="text"><b>Are you sure that you want to permanently delete the selected user(s)?</b><br /><b>This will also delete any uploaded files. Be careful, this process cannot be undone.</b></p>
